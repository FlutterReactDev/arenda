...
import { facilitiesFormSchema } from "@entites/Object/model/schemas/facilitiesFormSchema";
...
const FacilitiesForm: FC<FormProps> = (props) => {
  ...
  } = useAppSelector(getForm(3, 0)) as InferType<typeof facilitiesFormSchema>;
  ...
  const onSubmit = (data: InferType<typeof facilitiesFormSchema>) => {
    dispatch(
